					...
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
                                ...
                                <a href="{{ route('customer.create') }}" class="btn btn-primary float-right veiwbutton ">Add Appointments</a>
                            </div>
						</div>
					</div>
				</div>
										...
										@php $key = $key+1; @endphp
											<tr>
												...
												<form action="{{route('customer.destroy', $data->id)}}" method="post">
                                                   <a class="btn btn-success m-2" href="{{route('customer.edit', $data->id)}}">Edit</a>
                                                    @csrf
                                                    @method("Delete")
