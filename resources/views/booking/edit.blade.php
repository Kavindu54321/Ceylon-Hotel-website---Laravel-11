							...
							<div class="row formtype">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="bkn_id" value="{{$data->bkn_id}}"> </div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Name</label>
								...
								<div class="col-md-4">
									<div class="form-group">
										<label>Time</label>
										<div class="time-icon">
											<input type="text" class="form-control" id="datetimepicker3"value="{{$data->time}}" name="time"> </div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
