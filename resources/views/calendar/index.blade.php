					...
					<div class="modal-content">
						...
						@csrf
								<div class="form-group">
									...
									<input class="form-control form-white" placeholder="Enter name" type="text" name="name" /> </div>
								<div class="form-group">
									<label>Category Date</label>
									<input class="form-control form-white" placeholder="Enter date" type="text" name="date" /> </div>
